...
import type { WorldState, Character, LeaderboardEntry } from "@/lib/types";
...
const HUD: FC<Props> = ({
  ...
  loading, sessionScore, leaderboard, leaderboardReady, showLeaderboard,
  onToggleLeaderboard, epoch,
}) => {
    ...
    <>
      ...
      {showLeaderboard && (
        <div style={{
          ...
          <div style={{
            fontSize: "9px", letterSpacing: "2px", color: "#4A5568",
          ...
          {!leaderboardReady ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={{
                ...
                fontFamily: "Courier New, monospace", letterSpacing: "1px", marginBottom: "8px",
                ...
                <div key={entry.owner} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{
                      ...
                      fontFamily: "Courier New, monospace", letterSpacing: "1px",
                    }}>{entry.resourcesCollected} pts · LVL {entry.level}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div style={{
        ...
        {worldState && (
          <div style={{ textAlign: "center" }}>
            <div style={{
              fontSize: "9px", letterSpacing: "3px", color: "#4A5568",
              textTransform: "uppercase", fontFamily: "Courier New, monospace", marginBottom: "3px",
            }}>EPOCH {worldState.epoch} · MUNDO</div>
            <div style={{
              ...
              <div style={{
                ...
                background: worldPct > 80
                  ? "linear-gradient(90deg, #F59E0B, #EF4444)"
                  : "linear-gradient(90deg, #00C2A8, #F59E0B)",
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{
                  ...
                  {character.resourcesCollected} pts
                  {sessionScore > 0 && (
                    <span style={{ color: "#F59E0B", marginLeft: "8px" }}>+{sessionScore} sesión</span>
                  )}
                </div>
              </div>
            </div>
